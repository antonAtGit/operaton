...
public abstract @NullMarked class AbstractSetTaskPropertyCmd<T> implements Command<Void> {
   ...
   */
  protected @NonNull TaskEntity validateAndGet(@NonNull String taskId, @NonNull CommandContext context) {
   ...
   */
  protected <S> S ensureNotNullAndGet(String variableName, @Nullable S value) {
